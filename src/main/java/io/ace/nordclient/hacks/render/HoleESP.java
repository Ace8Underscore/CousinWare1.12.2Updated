...
public class HoleESP extends Hack {
    ...
    public HoleESP() {
        ...
        CousinWare.INSTANCE.settingsManager.rSetting(fruitRender = new Setting("FruitRender", this, false, "HoleESPFruitRender", true));
        CousinWare.INSTANCE.settingsManager.rSetting(doubleHole = new Setting("DoubleHole", this, true, "HoleESPDoubleHole", true));
        CousinWare.INSTANCE.settingsManager.rSetting(radius = new Setting("Radius", this, 5, 1, 20, false, "HoleESPRadius", true));
        CousinWare.INSTANCE.settingsManager.rSetting(rObi = new Setting("RedObi", this, 255, 0, 255, true, "HoleESPRedObi", true));
        CousinWare.INSTANCE.settingsManager.rSetting(gObi = new Setting("GreenObi", this, 26, 0, 255, true, "HoleESPGreenObi", true));
        CousinWare.INSTANCE.settingsManager.rSetting(bObi = new Setting("BlueObi", this, 255, 0, 255, true, "HoleESPBlueObi", true));
        CousinWare.INSTANCE.settingsManager.rSetting(rRock = new Setting("RedRock", this, 0, 0, 255, true, "HoleESPRedRock", true));
        CousinWare.INSTANCE.settingsManager.rSetting(gRock = new Setting("GreenRock", this, 255, 0, 255, true, "HoleESPGreenRock", true));
        CousinWare.INSTANCE.settingsManager.rSetting(bRock = new Setting("BlueRock", this, 0, 0, 255, true, "HoleESPBlueRock", true));
        CousinWare.INSTANCE.settingsManager.rSetting(alpha = new Setting("Alpha", this, 60, 0, 255, true, "HoleESPAlpha", true));
        CousinWare.INSTANCE.settingsManager.rSetting(outlineAlpha = new Setting("OutlineAlpha", this, 200, 0, 255, true, "HoleESPOutlineAlpha", true));
        CousinWare.INSTANCE.settingsManager.rSetting(width = new Setting("Width", this, 2, 0, 10, true, "HoleESPWidth", true));
    }
